$(document).ready(function () {
    ...
    function header_change() {
        ...
        // 햄버거 메뉴 라인 색상 변경
        header_more.children().addClass('header-more-line-active');
    }
    ...
    function header_undo() {
        ...
        header_more.children().removeClass('header-more-line-active');
    }
    ...
    let line_top = $('.header-more-line-top');
    let line_middle = $('.header-more-line-middle');
    let line_bottom = $('.header-more-line-bottom');

    header_more.click(function () {
        let temp = submenu.hasClass('submenu-active') && line_top.hasClass('header-more-line-top-active') && line_middle.hasClass('header-more-line-middle-active') && line_bottom.hasClass('header-more-line-bottom-active');
        
        if(temp != true){
            submenu.addClass('submenu-active');
            line_top.addClass('header-more-line-top-active');
            line_middle.addClass('header-more-line-middle-active');
            line_bottom.addClass('header-more-line-bottom-active');
        }else{
            submenu.removeClass('submenu-active');
            line_top.removeClass('header-more-line-top-active');
            line_middle.removeClass('header-more-line-middle-active');
            line_bottom.removeClass('header-more-line-bottom-active');
        }
    })
